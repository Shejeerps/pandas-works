...
print("how many reviews in each movie\n",data["title"].value_counts())

print("average review of movies",data.groupby("title")["rating"].mean())

print("year wise movie count",movies["year"].value_counts())

print("language wise movie count",movies["language"].value_counts())

print("language wise review count",data["language"].value_counts())

print("language wise average rating",data.groupby("language")["rating"].mean())